...
class Mo_Tech_YT(object):
    ...
    MO_TECH_YT_04 = os.environ.get("DB_NAME", "suraj")
    ...
    MO_TECH_YT_13 = os.environ.get("PHOTTO", "https://telegra.ph/SERIES-MOVIES-10-17")
    MO_TECH_YT_14 = os.environ.get("FSUB_TEXT", "Join My Group")
    MO_TECH_YT_15 = os.environ.get("FORCES_SUB", "@seriesmovieszz")
